...
I used to over-engineer my dotfiles until I realized I had built an objectively useful Vim plugin[^1] I never used.
...
plugin that covered most of what I thought I wanted. However, after using the plugin, the itch grew stronger when I saw the endless ways
in which the plugin could be further improved. The solution to my initial problem had quietly opened a rabbit hole of new problems I now
felt the need to solve. Why?
...
to master more concepts that actually feel rewarding in the end, you need to start under-engineering your dotfiles.
...
functional and leave room for the occasional iteration. I try to apply the KISS principle[^3] to my dotfiles and limit the amount of time
spent on an iteration to a couple of hours. From there, I use the new iteration for an extended period before deciding whether to keep, refine,
or revert it.
